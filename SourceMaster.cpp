...
//
//	//AVL para nombre
//	avlnom->add(new Archivo("holaaaaa.gaa", "gaa", 64.44, 9)    );
//	avlnom->add(new Archivo("genteeeaaaa.txt", "txt", 112.85, 4)	);
//	avlnom->add(new Archivo("agente.ppt", "ppt", 180.44, 5)	);
//	avlnom->add(new Archivo("alagut.txt", "txt", 90.10, 1)	);
//	avlnom->add(new Archivo(" son las 23 con 45 mascota minutoaaas.gaa", "gaa", 64.44, 3)     );
//	avlnom->add(new Archivo("quien es gary mascothaaaaa.gaa", "gaa", 64.44, 7)   );
//
//
//	vector <Archivo*> V = avlnom->antiinorderV();
//	
//	avlnom->inorder(Mostrar);
//	cout << endl;
//	
//	vector <Archivo*> F = avlnom->FiltradoTerminaCon("aaa", V);
...
int main()
{
	...
	for (auto entry : fs::directory_iterator(path)) {
		...
		cout << ImprimirExtension(ext) << endl << endl;
